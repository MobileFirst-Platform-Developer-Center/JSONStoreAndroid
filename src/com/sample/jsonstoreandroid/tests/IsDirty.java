...
public class IsDirty extends AndroidTestCase {

	public IsDirty() {
		super();
	}

	public void testIsDirty() throws Throwable {
		...
		try {
			...
			//Check if document with _id equal to 1 is dirty
			boolean isDirty = people.isDocumentDirty(1);
